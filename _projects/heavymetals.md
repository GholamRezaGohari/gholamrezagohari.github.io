...
img: assets/img/heavy_metals.png
importance: 1
...
{% include figure.liquid loading="eager" path="assets/img/heavy_metals.png" title="Graphical abstract" class="img-fluid rounded z-depth-1" %}
:::
::::
...
[DOI](https://doi.org/10.3390/rs13091698)

<br>

{% include figure.liquid loading="lazy" path="assets/img/p16.png" title="Paper 1 GA" class="img-fluid rounded z-depth-1" %}
...
[DOI](http://researchdata.uwe.ac.uk/659)

<br>

{% include figure.liquid loading="lazy" path="assets/img/p17.png" title="Paper 2 GA" class="img-fluid rounded z-depth-1" %}
...
[DOI](https://doi.org/10.1007/s10653-025-02533-6)

<br>

{% include figure.liquid loading="lazy" path="assets/img/p18.png" title="Paper 3 GA" class="img-fluid rounded z-depth-1" %}
