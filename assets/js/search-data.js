...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "List not exhaustive — see Google Scholar.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-soil-mapping",
          title: 'Soil Mapping',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/DSM_project/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/Deep_project/";
            },},{id: "projects-dust-pollution",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/airquality/";
            },},{id: "projects-stacking",
          title: 'Stacking',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/ensemble/";
            },},{id: "projects-extrapolation",
          title: 'Extrapolation',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/extr_project/";
            },},{id: "projects-heavy-metals",
          title: 'Heavy Metals',
          description: "Models contamination and exposure drivers to map risk hotspots, guiding sampling, remediation, and public-health interventions.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/heavymetals/";
            },},{id: "projects-x-ai",
          title: 'X-AI',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/inter_xai/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/landsuitability/";
            },},{id: "projects-soil-health",
          title: 'Soil Health',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/qualitysoil/";
            },},{id: "projects-remote-sensing",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/remotesensing/";
            },},{id: "projects-review-papers",
          title: 'Review Papers',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/review/";
            },},{id: "projects-soc",
          title: 'SOC',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/soc_map/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/soilerosion/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/soilmoisture/";
            },},{id: "projects-soil-salinity",
          title: 'Soil Salinity',
          description: "Maps salinity risk and trends using ML with terrain, climate, land use, and remote sensing to guide mitigation.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/soilsalinity/";
            },},{id: "projects-ml-mapping-of-soil-salinity-for-land-degradation",
          title: 'ML Mapping of Soil Salinity for Land Degradation',
          description: "Maps salinity risk and trends using ML with terrain, climate, land use, and remote sensing to guide mitigation.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/soilsalinitymap/";
